namespace AdvancedTeamCreation.API
{
    ...
    public class AdvancedTeam
    {
        ...
        public SubTeam[] Subclasses { get; set; } = new SubTeam[] { };
        ...
        public bool TryGetSubteam(string name, out SubTeam subteam)
        {
            if (name == null)
            {
                subteam = null;
        ...
        public static AdvancedTeam Get(string name) => Instance.Config.Teams?.FirstOrDefault(x => x.Name == name);

        public static bool TryGet(string name, out AdvancedTeam team)
        {
            if (name == null)
            {
                team = null;
